...
def main():
	...
	#[test_predicted_merged,Y_test_merged] = mergeMultioutputToSingleoutput2(test_predicted,Y_test)
	#[train_predicted_merged,Y_train_merged] = mergeMultioutputToSingleoutput2(train_predicted,Y_train)
	#[validate_predicted_merged,Y_validate_merged] = mergeMultioutputToSingleoutput2(validate_predicted,Y_validate)

...
for ((i=1;i<=simulations;i++)); do ## for run in simulations runs
	...
	echo "SKIPPING THE PROCESSING STEPS FOR NOW" 
...
# 		
# 		Ne=`echo $(( $N * $subpopCount ))`
# 		
# 		command2="python /home/kprovost/nas2/Analysis_SLiM/Overlaying_neutral_mutations_AND_recapitate_klp.py \
...
# 				
# 		command3="perl /home/kprovost/nas2/Analysis_SLiM/vcf2MS.pl \
# 		$filename-$TIMESTAMP-$i-recap.vcf $filename-$TIMESTAMP-$i-recap.fulltemp $Ne"
# 		
# 		
# 		echo "----------------------------"
# 		echo "Command3 is:"
...
# 		echo "subsetting"
# 		
# 		command4="python /home/kprovost/nas2/Analysis_SLiM/select_ms_individuals.py \
# 		$$filename-$TIMESTAMP-$i-recap.fulltemp \
# 		$outSamp"
# 
# 		echo "----------------------------"
# 		echo "Command4 is:"
...
# 		echo "(Output to ${f}-${TIMESTAMP}.sumstats.stats -- skipped)"
# 		echo

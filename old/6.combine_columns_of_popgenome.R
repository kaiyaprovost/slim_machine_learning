...
if (doPopgenome==TRUE) {
  ...
  # pathlist=c("/Users/kprovost/Dropbox (AMNH)/Dissertation/CHAPTER1_REVIEW/SLIM/runs/STATS_testing/scale0.25/",
  #            "/Users/kprovost/Dropbox (AMNH)/Dissertation/CHAPTER1_REVIEW/SLIM/runs/STATS_testing/scale0.50/",
  #            "/Users/kprovost/Dropbox (AMNH)/Dissertation/CHAPTER1_REVIEW/SLIM/runs/STATS_testing/scale1/",
  #            "/Users/kprovost/Dropbox (AMNH)/Dissertation/CHAPTER1_REVIEW/SLIM/runs/STATS_testing/scale2/",
  #            "/Users/kprovost/Dropbox (AMNH)/Dissertation/CHAPTER1_REVIEW/SLIM/runs/STATS_testing/scale4/")
  
  
  pathlist = c(
    # "/Users/kprovost/Dropbox (AMNH)/Dissertation/CHAPTER1_REVIEW/SLIM/runs/STATS_testing/TESTING/RECAPSTATS/1000K/MODEL8/",
    # "/Users/kprovost/Dropbox (AMNH)/Dissertation/CHAPTER1_REVIEW/SLIM/runs/STATS_testing/TESTING/RECAPSTATS/1000K/MODEL7/",
    # "/Users/kprovost/Dropbox (AMNH)/Dissertation/CHAPTER1_REVIEW/SLIM/runs/STATS_testing/TESTING/RECAPSTATS/1000K/MODEL6/",
    # "/Users/kprovost/Dropbox (AMNH)/Dissertation/CHAPTER1_REVIEW/SLIM/runs/STATS_testing/TESTING/RECAPSTATS/1000K/MODEL5/",
    # "/Users/kprovost/Dropbox (AMNH)/Dissertation/CHAPTER1_REVIEW/SLIM/runs/STATS_testing/TESTING/RECAPSTATS/1000K/MODEL4/",
    # "/Users/kprovost/Dropbox (AMNH)/Dissertation/CHAPTER1_REVIEW/SLIM/runs/STATS_testing/TESTING/RECAPSTATS/1000K/MODEL3/",
    # "/Users/kprovost/Dropbox (AMNH)/Dissertation/CHAPTER1_REVIEW/SLIM/runs/STATS_testing/TESTING/RECAPSTATS/1000K/MODEL2/",
    # "/Users/kprovost/Dropbox (AMNH)/Dissertation/CHAPTER1_REVIEW/SLIM/runs/STATS_testing/TESTING/RECAPSTATS/1000K/MODEL1/",
    # "/Users/kprovost/Dropbox (AMNH)/Dissertation/CHAPTER1_REVIEW/SLIM/runs/STATS_testing/TESTING/RECAPSTATS/120K/MODEL8/",
    # "/Users/kprovost/Dropbox (AMNH)/Dissertation/CHAPTER1_REVIEW/SLIM/runs/STATS_testing/TESTING/RECAPSTATS/120K/MODEL7/",
    # "/Users/kprovost/Dropbox (AMNH)/Dissertation/CHAPTER1_REVIEW/SLIM/runs/STATS_testing/TESTING/RECAPSTATS/120K/MODEL6/",
    # "/Users/kprovost/Dropbox (AMNH)/Dissertation/CHAPTER1_REVIEW/SLIM/runs/STATS_testing/TESTING/RECAPSTATS/120K/MODEL5/",
    # "/Users/kprovost/Dropbox (AMNH)/Dissertation/CHAPTER1_REVIEW/SLIM/runs/STATS_testing/TESTING/RECAPSTATS/120K/MODEL4/",
    # "/Users/kprovost/Dropbox (AMNH)/Dissertation/CHAPTER1_REVIEW/SLIM/runs/STATS_testing/TESTING/RECAPSTATS/120K/MODEL3/",
    # "/Users/kprovost/Dropbox (AMNH)/Dissertation/CHAPTER1_REVIEW/SLIM/runs/STATS_testing/TESTING/RECAPSTATS/120K/MODEL2/",
    # "/Users/kprovost/Dropbox (AMNH)/Dissertation/CHAPTER1_REVIEW/SLIM/runs/STATS_testing/TESTING/RECAPSTATS/120K/MODEL1/",
    # "/Users/kprovost/Dropbox (AMNH)/Dissertation/CHAPTER1_REVIEW/SLIM/runs/STATS_testing/TESTING/RECAPSTATS/21K/MODEL8/",
    # "/Users/kprovost/Dropbox (AMNH)/Dissertation/CHAPTER1_REVIEW/SLIM/runs/STATS_testing/TESTING/RECAPSTATS/21K/MODEL7/",
    # "/Users/kprovost/Dropbox (AMNH)/Dissertation/CHAPTER1_REVIEW/SLIM/runs/STATS_testing/TESTING/RECAPSTATS/21K/MODEL6/",
    # "/Users/kprovost/Dropbox (AMNH)/Dissertation/CHAPTER1_REVIEW/SLIM/runs/STATS_testing/TESTING/RECAPSTATS/21K/MODEL5/",
    # "/Users/kprovost/Dropbox (AMNH)/Dissertation/CHAPTER1_REVIEW/SLIM/runs/STATS_testing/TESTING/RECAPSTATS/21K/MODEL4/",
    # "/Users/kprovost/Dropbox (AMNH)/Dissertation/CHAPTER1_REVIEW/SLIM/runs/STATS_testing/TESTING/RECAPSTATS/21K/MODEL3/",
    # "/Users/kprovost/Dropbox (AMNH)/Dissertation/CHAPTER1_REVIEW/SLIM/runs/STATS_testing/TESTING/RECAPSTATS/21K/MODEL2/",
    # "/Users/kprovost/Dropbox (AMNH)/Dissertation/CHAPTER1_REVIEW/SLIM/runs/STATS_testing/TESTING/RECAPSTATS/21K/MODEL1/",
    # "/Users/kprovost/Dropbox (AMNH)/Dissertation/CHAPTER1_REVIEW/SLIM/runs/STATS_testing/TESTING/RECAPSTATS/6K/MODEL8/",
    # "/Users/kprovost/Dropbox (AMNH)/Dissertation/CHAPTER1_REVIEW/SLIM/runs/STATS_testing/TESTING/RECAPSTATS/6K/MODEL7/",
    # "/Users/kprovost/Dropbox (AMNH)/Dissertation/CHAPTER1_REVIEW/SLIM/runs/STATS_testing/TESTING/RECAPSTATS/6K/MODEL6/",
    # "/Users/kprovost/Dropbox (AMNH)/Dissertation/CHAPTER1_REVIEW/SLIM/runs/STATS_testing/TESTING/RECAPSTATS/6K/MODEL5/",
    # "/Users/kprovost/Dropbox (AMNH)/Dissertation/CHAPTER1_REVIEW/SLIM/runs/STATS_testing/TESTING/RECAPSTATS/6K/MODEL4/",
    # "/Users/kprovost/Dropbox (AMNH)/Dissertation/CHAPTER1_REVIEW/SLIM/runs/STATS_testing/TESTING/RECAPSTATS/6K/MODEL3/",
    # "/Users/kprovost/Dropbox (AMNH)/Dissertation/CHAPTER1_REVIEW/SLIM/runs/STATS_testing/TESTING/RECAPSTATS/6K/MODEL2/",
    # "/Users/kprovost/Dropbox (AMNH)/Dissertation/CHAPTER1_REVIEW/SLIM/runs/STATS_testing/TESTING/RECAPSTATS/6K/MODEL1/",
    #"/Users/kprovost/Dropbox (AMNH)/Dissertation/CHAPTER1_REVIEW/SLIM/runs/STATS_testing/TESTING/NOTRECAPSTATS/1000K",
    #"/Users/kprovost/Dropbox (AMNH)/Dissertation/CHAPTER1_REVIEW/SLIM/runs/STATS_testing/TESTING/NOTRECAPSTATS/120K"
    #"/Users/kprovost/Dropbox (AMNH)/Dissertation/CHAPTER1_REVIEW/SLIM/runs/STATS_testing/TESTING/VCFTESTDATA/"
  )
  
  pathlist = c("/Users/kprovost/Dropbox (AMNH)/Dissertation/CHAPTER2_GENOMES/ANALYSIS/")
  ...
  for (path in pathlist) {
    ...
    setwd(path)
    #files = list.files(pattern = "*popgenome.stats$", recursive = FALSE)
    files = list.files(pattern = "*txt$", recursive = FALSE)
    files = sample(files)
    print(length(files))
    ...
    for (i in 1:blocks) {
      ...
      write.table(merged,"MERGEDPOP_empirical_scales.txt",append=T,row.names=F)
      ...
      write.table(panyes.120,"MERGEDPOP_panyes.120.txt",append=T,row.names=F)
      write.table(panno.120,"MERGEDPOP_panno.120.txt",append=T,row.names=F)
      write.table(isoyes.120,"MERGEDPOP_isoyes.120.txt",append=T,row.names=F)
      write.table(isono.120,"MERGEDPOP_isono.120.txt",append=T,row.names=F)
      write.table(gfyes.120,"MERGEDPOP_gfyes.120.txt",append=T,row.names=F)
      write.table(gfno.120,"MERGEDPOP_gfno.120.txt",append=T,row.names=F)
      write.table(secyes.120,"MERGEDPOP_secyes.120.txt",append=T,row.names=F)
      write.table(secno.120,"MERGEDPOP_secno.120.txt",append=T,row.names=F)
      
      write.table(panyes.21,"MERGEDPOP_panyes.21.txt",append=T,row.names=F)
      write.table(panno.21,"MERGEDPOP_panno.21.txt",append=T,row.names=F)
      write.table(isoyes.21,"MERGEDPOP_isoyes.21.txt",append=T,row.names=F)
      write.table(isono.21,"MERGEDPOP_isono.21.txt",append=T,row.names=F)
      write.table(gfyes.21,"MERGEDPOP_gfyes.21.txt",append=T,row.names=F)
      write.table(gfno.21,"MERGEDPOP_gfno.21.txt",append=T,row.names=F)
      write.table(secyes.21,"MERGEDPOP_secyes.21.txt",append=T,row.names=F)
      write.table(secno.21,"MERGEDPOP_secno.21.txt",append=T,row.names=F)
      
      write.table(panyes.6,"MERGEDPOP_panyes.6.txt",append=T,row.names=F)
      write.table(panno.6,"MERGEDPOP_panno.6.txt",append=T,row.names=F)
      write.table(isoyes.6,"MERGEDPOP_isoyes.6.txt",append=T,row.names=F)
      write.table(isono.6,"MERGEDPOP_isono.6.txt",append=T,row.names=F)
      write.table(gfyes.6,"MERGEDPOP_gfyes.6.txt",append=T,row.names=F)
      write.table(gfno.6,"MERGEDPOP_gfno.6.txt",append=T,row.names=F)
      write.table(secyes.6,"MERGEDPOP_secyes.6.txt",append=T,row.names=F)
      write.table(secno.6,"MERGEDPOP_secno.6.txt",append=T,row.names=F)
